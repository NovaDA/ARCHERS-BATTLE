...
namespace RhinoGame
{
	...
	public class AudioManager : MonoBehaviour
	{
		...
		void Awake ()
		{
            ...
            ///bgMusic = GetComponent<AudioSource>(); ==> Need to get the source music in each scenen
        }
		/// <summary>
        ...
        public static void PlayBackGroundMusic()   // AudioClip musicToPlay ==> Previous Parameter
        {
            ...
            bgMusic.Play();
            bgMusic.loop = true;
            Debug.Log("Playing Music" + bgMusic.clip.name);
        }
